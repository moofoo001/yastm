...
namespace YASTM
{
    public class YASTM_ModSettings : ModSettings
    {
        ...
        public int   tricorderCooldownSeconds = 30;        // 0..600
        public int   transporterMaxRange      = 300;       // 3..300 tiles
        public int   transporterCooldownSeconds = 10;      // 0..300

        // --- Alerts ---
        public float alertVolume = 1.0f;                   // 0.0 .. 2.0
        public bool  showAlertTimerInGizmo = true;
        public int   defaultBlinkSeconds = 3;
        public int   defaultRedCooldownSeconds = 5;
        public int   defaultYellowCooldownSeconds = 5;
        public int   defaultRedDurationSeconds = 0;
        public int   defaultYellowDurationSeconds = 0;
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref transporterMaxRange,      "transporterMaxRange",      300);
            ...
            // Force Field (NEU)
            Scribe_Values.Look(ref forceFieldRadius,        "forceFieldRadius",        8);
            Scribe_Values.Look(ref forceFieldRefreshTicks,  "forceFieldRefreshTicks",  60);
            Scribe_Values.Look(ref forceFieldHostilesOnly,  "forceFieldHostilesOnly",  false);
        ...
        public void ClampAll()
        {
            ...
            transporterMaxRange        = Mathf.Clamp(transporterMaxRange,        3, 300);
            ...
            forceFieldRadius       = Mathf.Clamp(forceFieldRadius,       2, 20);
            forceFieldRefreshTicks = Mathf.Clamp(forceFieldRefreshTicks, 10, 600);
        }
    ...
    public class YASTM_Mod : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            Settings.transporterMaxRange =
                Mathf.RoundToInt(ls.Slider(Settings.transporterMaxRange, 3, 300));
            ...
            ls.Gap(12);
            // Force Field (NEU)
            ls.Label("YASTM.Settings.ForceField.Radius".Translate(Settings.forceFieldRadius));
            Settings.forceFieldRadius = Mathf.RoundToInt(ls.Slider(Settings.forceFieldRadius, 2, 20));
            ls.Label("YASTM.Settings.ForceField.Refresh".Translate(Settings.forceFieldRefreshTicks));
            Settings.forceFieldRefreshTicks = Mathf.RoundToInt(ls.Slider(Settings.forceFieldRefreshTicks, 10, 600));
            ls.CheckboxLabeled("YASTM.Settings.ForceField.HostilesOnly".Translate(), ref Settings.forceFieldHostilesOnly);
